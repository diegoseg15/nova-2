...
if (!$canManage) {
    ...
    echo '<p>No tiene permiso para crear instituciones.</p>';
    echo '</div>';
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
    <div>
        <h1 style="margin:0;font-size:24px;color:#0f172a;">Nueva institución</h1>
        <p style="margin:4px 0 0;color:#64748b;font-size:14px;">
            Registro de institución educativa en NOVA 1.0
        </p>
    </div>
...
<form method="POST" action="/nova1/modules/school_regime/institutions/store.php">
